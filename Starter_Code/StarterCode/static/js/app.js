...
function selectedMetadata(sample) {
    d3.json("https://static.bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json").then((data) => {
        ...
        let header = document.getElementById('demographic-header');
        header.style.color = 'blue';
        header.style.fontSize = '24px';
    });
}

//create a function for constructing the charts
...
//crate the init function call the selectedMetadata and constructCharts functions
function init() {
...
//create the function for new data each time the option is changed
